 ...
 * <p>
 *     This controller class is responsible for adding appointments to the mySQL database.
 * </p>
 */
...
public class AddAppointmentController implements Initializable {
    ...
    /**
     * This initializer method sets values in the tableview and the combo boxes by calling SQL queries.
     * @param location
    ...
    /**
     * This method is called when the add button is clicked. It adds the appointment to the database after checking all input fields for validity.
    ...
    public void onAddButton(ActionEvent actionEvent) throws SQLException, IOException {
        try {
            ...
            if (!checkOverlapTimes(customerID, startTime, endTime)) {
                return;
            }

            // Start/End time check
            if (!startEndTimeCompare()) {
                Alert alert = new Alert(Alert.AlertType.ERROR);
                alert.setTitle("Start Time/End Time Conflict");
            ...
            // Appointment Instantiation/Query
            ...
            int rowsAffected = AppointmentQuery.addAppointment(appointment);
    ...
    public boolean checkIfCustomerExists(int customerID) throws SQLException {
    ...
    public boolean startEndTimeCompare() {
        // Start/End time check
    ...
    public boolean checkOverlapTimes(int id, LocalDateTime start, LocalDateTime end) throws SQLException {
        ObservableList<CustomerAppointmentTimes> allTimes = AppointmentQuery.getCustomerAppointmentTimes(id);
